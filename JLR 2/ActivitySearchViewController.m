...
@interface ActivitySearchViewController ()
{
    UIAlertView *alert;
...
- (void)viewDidLoad {
    ...
    _textSearch.rightViewMode = UITextFieldViewModeAlways;
    _textSearch.rightView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"textbox_icon_2@2x.png"]];
    _textSearch.rightView.frame = CGRectMake(0, 0, 30, 30);

    _textactivitytype.rightViewMode = UITextFieldViewModeAlways;
    _textactivitytype.rightView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"textlist@2x.png"]];
    _textactivitytype.rightView.frame = CGRectMake(0, 0, 30, 30);
   
    
    _textstatus.rightViewMode = UITextFieldViewModeAlways;
    _textstatus.rightView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"textlist@2x.png"]];
    _textstatus.rightView.frame = CGRectMake(0, 0, 30, 30);
    
 
    _textdse.rightViewMode = UITextFieldViewModeAlways;
    _textdse.rightView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"textlist@2x.png"]];
    _textdse.rightView.frame = CGRectMake(0, 0, 30, 30);
